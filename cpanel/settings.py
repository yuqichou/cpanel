...
DATABASES = {
    'default': {
        ...
        'NAME': 'cpanel',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^g7)*byu7@z&amp;fhd4kc&amp;84-_lw*2^zv&amp;gt-prlj75hzif*6b!-y'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "apps.contents.context_processors.global_list_per_page",
)
